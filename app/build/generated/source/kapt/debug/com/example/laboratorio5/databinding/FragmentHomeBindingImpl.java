...
public class FragmentHomeBindingImpl extends FragmentHomeBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.iniciarencuesta, 3);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.user == variableId) {
            setUser((com.example.laboratorio5.Model) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setUser(@Nullable com.example.laboratorio5.Model User) {
        this.mUser = User;
    }
