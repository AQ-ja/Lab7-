...
public class QuestionFragmentBindingImpl extends QuestionFragmentBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.preguntaShow, 1);
        sViewsWithIds.put(R.id.ratingBar, 2);
        sViewsWithIds.put(R.id.respuesta, 3);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.amq == variableId) {
            setAmq((com.example.laboratorio5.Model) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setAmq(@Nullable com.example.laboratorio5.Model Amq) {
        this.mAmq = Amq;
    }
