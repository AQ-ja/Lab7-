...
public abstract class FragmentHomeBinding extends ViewDataBinding {
  ...
  @NonNull
  public final Button iniciarencuesta;

  @Bindable
  protected Model mUser;

  protected FragmentHomeBinding(Object _bindingComponent, View _root, int _localFieldCount,
      FloatingActionButton fab, ImageView imageView2, Button iniciarencuesta) {
    super(_bindingComponent, _root, _localFieldCount);
    this.fab = fab;
    this.imageView2 = imageView2;
    this.iniciarencuesta = iniciarencuesta;
  }

  public abstract void setUser(@Nullable Model user);
